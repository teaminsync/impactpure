          ...
          <FadeIn>
            <div className="bg-gradient-to-r from-primary-600 to-primary-700 rounded-2xl p-8 text-white text-center">
              ...
              <p className="text-primary-100 leading-relaxed max-w-3xl mx-auto">
                Under no circumstances are the terms mentioned above negotiable and no employee of Kalki Ecosphere LLP
                has the authority to supersede them. Kalki Ecosphere reserves the right to alter or improve design and
                specifications at any time, without any contingent obligations to prospective buyers or owners of the
